...
export const AboutMeComponent = () => {
  ...
  return (
    <div className=" relative flex flex-wrap justify-around gap-5 md:gap-10 xl:gap-0 lg:grid lg:grid-cols-12 lg:grid-rows-6 xl:grid-rows-5 w-full md:h-4/5 px-6 pt-6 md:px-10 md:pt-10  lg:max-h-[48rem] max-w-screen-2xl">
      <div className="bg-white mx-auto lg:mx-0  xl:ml-16 max-w-md 2xl:text-5xl text-3xl p-4  md:text-4xl leading-normal md:leading-[1.7] flex flex-col place-items-center 2xl:leading-relaxed justify-center lg:w-2xl lg:p-6 lg:max-w-2xl lg:col-start-6 xl:col-start-6 xl:col-span-5 lg:col-span-6 2xl:max-h-max h-fit  lg:mt-8 xl:mt-16 border-8 border-black border-dotted">
      ...
      <div className="bg-white lg:w-sm p-4 max-w-sm w-48 xl:w-36 mx-auto md:mx-4 lg:mx-2 h-max xl:col-start-11 xl:ml-16 lg:col-start-10 lg:col-span-3 lg:row-start-5 lg:mt-8 lg:ml-6 xl:col-span-2 xl:mb-16 xl:row-start-3 xl:mt-20 text-2xl xl:text-lg border-8 border-black border-dashed">
        <p>{"I've beaten Sekiro on NG+"}</p>
      </div>
      <div className="bg-white lg:mt-6 lg:w-max p-4 2xl:p-8 lg:px-6 max-w-max h-max xl:text-4xl text-3xl border-4 border-black border-solid xl:col-start-11 xl:ml-10 xl:row-start-1 lg:col-start-7 lg:row-start-4 leading-relaxed">
        My{" "}
        <a
      ...
      <div className="group relative w-max lg:w-sm max-w-sm h-max xl:col-start-1 xl:mx-10 xl:col-span-2 lg:mb-16 xl:row-start-1 lg:mt-16 text-2xl xl:text-lg md:text-xl lg:col-start-10 lg:row-start-4 ">
      ...
      <div className="text-center md:max-w-xs lg:text-left bg-white xl:mt-6 p-2 lg:mt-6 2xl:p-8 lg:p-6 text-2xl ml-14 lg:ml-0 max-w-sm lg:w-sm border-4 border-black border-dotted xl:col-start-4 xl:row-start-2 h-max xl:col-span-2 lg:col-start-2 lg:col-span-3 lg:row-start-4 lg:-mr-10 leading-relaxed">
