...
export const BreazyImageComponent = () => {
  return (
    <div className="bg-white hover:w-1/4  w-96 p-4 h-max text-2xl border-4 border-black border-dashed relative group hover:bg-black hover:border-white transition-all duration-300">
      <Link
        target="_blank"
