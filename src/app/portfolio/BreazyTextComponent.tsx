...
export const BreazyTextComponent = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row  lg:flex-wrap sm:w-1/2 lg:w-3/5 place-items-center  sm:items-end lg:place-items-start lg:place-content-start gap-6 md:gap-8">
      ...
      {readMore && (
        <>
          <div className=" bg-white p-2 md:p-4 h-max border-4 border-black border-dashed relative sm:w-max w-full sm:max-w-xs lg:max-w-xl xl:max-w-xs 2xl:max-w-sm">
          ...
          <div className="sm:place-self-end bg-white p-2 md:p-4 h-max border-4 border-black border-dashed relative sm:w-max w-full sm:max-w-md lg:max-w-lg xl:max-w-xs 2xl:max-w-md">
            <h1 className="text-xl md:text-2xl font-bold">ACCOMPLISHMENTS:</h1>
